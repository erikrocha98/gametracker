export const texts = {
  ...
  myLists: {
    ...
    deleteConfirmDescription: (name: string) => `Tem certeza que deseja excluir a lista "${name}"? Esta ação não pode ser desfeita.`,
    ...
    detailGamesEmptyDescription: 'Use o botão "Adicionar à lista" na página de um jogo para incluí-lo aqui.',
    removeGameAriaLabel: 'Remover jogo da lista',
    removeGameSuccessMessage: 'Jogo removido da lista com sucesso!',
    removeGameErrorMessage: 'Não foi possível remover o jogo da lista. Tente novamente.',
  },
  addToList: {
    dialogTitle: 'Adicionar à lista',
    loadError: 'Não foi possível carregar suas listas.',
    emptyTitle: 'Nenhuma lista criada',
    emptyDescription: 'Crie uma lista para começar a organizar seus jogos.',
    createListCta: 'Ir para Minhas listas',
    alreadyInListLabel: 'Já adicionado',
    listFullLabel: 'Lista cheia',
    countLabel: (count: number) => `${count} jogo${count !== 1 ? 's' : ''}`,
    successMessage: 'Jogo adicionado à lista com sucesso!',
    errorMessage: 'Não foi possível adicionar o jogo à lista. Tente novamente.',
    alreadyInListError: 'Este jogo já está nesta lista.',
    listFullError: 'Esta lista atingiu o limite de 50 jogos.',
    closeButton: 'Fechar',
  },
  comingSoon: {
    title: 'Em breve',
  ...
  reviews: {
    pageTitle: 'Reviews',
    emptyTitle: 'Nenhuma review escrita',
    emptyDescription: 'Escreva reviews dos seus jogos para vê-las aqui.',
    emptyAction: 'Ver meus jogos',
    loadError: 'Não foi possível carregar suas reviews.',
  },
  gameDetails: {
    ...
    reviewSectionTitle: 'Sua review',
    reviewPlaceholder: 'Escreva o que você achou deste jogo...',
    reviewCharCounter: (count: number) => `${count}/5000`,
    reviewSaveButton: 'Salvar review',
    reviewEditButton: 'Editar',
    reviewDeleteButton: 'Excluir',
    reviewCreatedAtLabel: (date: string) => `Escrita em ${date}`,
    reviewSaveSuccess: 'Review salva com sucesso!',
    reviewSaveError: 'Não foi possível salvar sua review. Tente novamente.',
    reviewDeleteSuccess: 'Review excluída.',
    reviewDeleteError: 'Não foi possível excluir sua review. Tente novamente.',
    reviewDeleteConfirmTitle: 'Excluir review',
    reviewDeleteConfirmDescription: 'Tem certeza que deseja excluir esta review? Esta ação não pode ser desfeita.',
    reviewDeleteConfirmButton: 'Excluir',
    reviewDeleteCancelButton: 'Cancelar',
  },
  profile: {
    pageTitle: 'Perfil',
